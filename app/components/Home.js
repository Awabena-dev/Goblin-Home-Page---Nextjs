  ...
  return (
    <div className='flex flex-col md:flex-row gap-10 items-center md:justify-center h-[full - 75px] py-[5rem] relative'>
      ...
      <div className='text-white pt-5 text'>
        ...
        <p className='mb-10'>clash of clans is one of best gaming video ever</p>
        <button className='py-2.5 px-4 bg-[#38703d] rounded-full border-2 border-transparent mr-3 hover:bg-transparent hover:border-white hover:translate-x-1.5 transition-all duration-300 cursor-pointer'>
          Download
        </button>
        <button className='py-2.5 px-4 bg-transparent rounded-full border-2 border-white hover:bg-[#38703d] hover:border-transparent hover:translate-x-1.5 transition-all duration-300 cursor-pointer'>
          Watch GamePlay
        </button>
      </div>
